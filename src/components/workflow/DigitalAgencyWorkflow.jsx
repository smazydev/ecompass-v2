                ...
                <div className="swiper-wrapper">
                  <SwiperSlide>
                    <div className="workflow__slide fade_left">
                      ...
                      <h6 className="workflow__title">Strategize</h6>
                  ...
                  <SwiperSlide>
                    <div className="workflow__slide fade_left">
                      ...
                      <h6 className="workflow__title">Design</h6>
                      <p>Craft Visual Brilliance</p>
                    </div>
                  </SwiperSlide>
                  ...
                  <SwiperSlide>
                    <div className="workflow__slide fade_left">
                      ...
                      <h6 className="workflow__title">Digitize</h6>
                  ...
                  <SwiperSlide>
                    <div className="workflow__slide fade_left">
                      ...
                      <h6 className="workflow__title">Optimize</h6>
                      <p>Enhance Performance Seamlessly</p>
                    </div>
                  </SwiperSlide>
