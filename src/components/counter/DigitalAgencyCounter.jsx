            ...
            <div className="col-xxl-12">
              <div className="counter__wrapper counter_animation">
                <div className="counter__item counter__anim">
                  <h2 className="counter__number count1">05+</h2>
                  <p>
                    Project <br />
                    completed
                  </p>
                ...
                <div className="counter__item counter__anim">
                  <h2 className="counter__number count2">05</h2>
                  <p>
                    Happy <br />
                    customers
                  </p>
                ...
                <div className="counter__item counter__anim">
                  <h2 className="counter__number count3">14</h2>
                  <p>
                ...
                <div className="counter__item counter__anim">
                  <h2 className="counter__number count4">100%</h2>
                  <p>
                    Satisfaction <br />
                  </p>
                  <span className="counter__border"></span>
