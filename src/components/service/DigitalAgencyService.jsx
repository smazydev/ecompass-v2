...
import Service11 from "../../../public/assets/imgs/service/1/services-1.png";
import Service12 from "../../../public/assets/imgs/service/1/services-2.png";
import Service13 from "../../../public/assets/imgs/service/1/services-3.png";
import Service14 from "../../../public/assets/imgs/service/1/services-4.png";
                ...
                <div className="service__list" ref={serviceList}>
                  <div className="service__item animation_home1_service">
                    ...
                    <div className="service__text">
                      <p>
                        Ecompasse catalyzes digital transformation, creating
                        goal-aligned websites and mobile apps with a focus on
                        user-centric design, scalability, and reliability for an
                  ...
                  <div className="service__item  animation_home1_service">
                    ...
                    <div className="service__text">
                      <p>
                        Ecompasse excels in transformative interaction design,
                        prioritizing innovation for seamless, engaging user
                        experiences across web and mobile platforms—your partner
                        in redefining digital interactions.
                      </p>
                    </div>
                    <div className="service__link">
                      <p>
                  ...
                  <div className="service__item  animation_home1_service">
                    ...
                    <div className="service__text">
                      <p>
                        Ecompasse excels in innovative digital marketing,
                        crafting engaging strategies for impactful online
                        presence. Your partner in redefining digital success.
                      </p>
                    </div>
                    <div className="service__link">
                      <p>
                  ...
                  <div className="service__item  animation_home1_service">
                    ...
                    <div className="service__text">
                      <p>
                        Ecompasse redefines brands with strategic brilliance,
                        crafting impactful identities. Your partner for
                        elevating brand presence and strategic success.
                      </p>
                    </div>
                    <div className="service__link">
                      <p>
